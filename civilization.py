...
class Civilization:
    ...
    def evaluate_borders(self, layer):
        ...
        for key in self.borders:
            #print('eval')
            #numCoast = local_layer.moore(CellType.COAST, key[0], key[1], 1)
            #numPlains = local_layer.moore(CellType.PLAINS, key[0], key[1], 1)
            #numHills = local_layer.moore(CellType.HILL, key[0], key[1], 1)
